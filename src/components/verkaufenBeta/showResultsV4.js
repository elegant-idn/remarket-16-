...
export class ShowResults extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          !window.isDesktop ? "resultSellPage for-mobile" : "resultSellPage"
        }
      >
            ...
            <ul className="nav nav-pills nav-justified" role="tablist">
              ...
              {!window.isDesktop && (
                <li
                  role="presentation"
                  className={
                    currentTab === "form" || currentTab === "instructions"
                      ? "active"
                      : null
                  }
                >
              ...
              <div className="clearfix periods">
                <div className="col-sm-4 itemPeriod">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      Löschen Sie alle Daten auf Ihrem Gerät indem Sie es auf

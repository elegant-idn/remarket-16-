...
export class ShowResults extends Component {
    ...
    if (this.state.inputCheckbox.agree) {
      ...
      axios
        ...
        .then((result) => {
          ...
          window.localStorage.setItem(
            "order",
            result.data[0].viewData.basketPayoutShortcode
          );
          window.localStorage.setItem(
            "template",
            JSON.stringify(result.data[0].viewData.templates)
          );
          window.localStorage.setItem(
            "PDFData",
            JSON.stringify(result.data[0].PDFData)
          );
          window.localStorage.setItem(
            "basketDataVerkaufenForSellPage",
            JSON.stringify(this.props.basket.basketDataVerkaufen)
          );
  ...
  _calculatePrice() {
    ...
    const sellDeadline = JSON.parse(
      window.localStorage.getItem("sellDeadline")
    );
    if (
      sellDeadline &&
      sellDeadline.isActive &&
  ...
  _gtag_report_conversion_Basel_Barfusserplatz = (url) => {
    ...
    gtag("event", "conversion", {
      send_to: "AW-827036726/CGLSCOnA1pYBELaorooD",
      event_callback: callback,
    });
  ...
  _gtag_report_conversion_Basel_St_Jakob = (url) => {
    ...
    gtag("event", "conversion", {
      send_to: "AW-827036726/VWneCM2d4pYBELaorooD",
      event_callback: callback,
    });
  ...
  _gtag_report_conversion_Bern_Shoppyland = (url) => {
    ...
    gtag("event", "conversion", {
      send_to: "AW-827036726/UHMXCOu_1pYBELaorooD",
      event_callback: callback,
    });
  ...
  render() {
    ...
    let { userAnswers, changeComment, goBack, user } = this.props,
      ...
      storageSellDeadline = JSON.parse(
        window.localStorage.getItem("sellDeadline")
      );
        ...
        <div className="tabs">
          <div className="tab-menu">
            <div className="tab-menu-top">
              <img loading="lazy" src="/images/design/home_new.svg" />
              <img
                loading="lazy"
                className="allow-img"
                src="/images/design/allow-right.svg"
              />
            ...
            <ul className="nav nav-pills nav-justified" role="tablist">
              <li
                role="presentation"
                className={currentTab === "summary" ? "active" : null}
              >
              ...
              <li
                role="presentation"
                className={currentTab === "form" ? "active" : null}
              >
              ...
              <li
                role="presentation"
                className={currentTab === "instructions" ? "active" : null}
              >
            ...
            <div className="tab-menu-bottom">
              {userAnswers &&
                ((currentTab === "summary" &&
                  ...
                  currentTab === "form") && (
                  <SendLinks user={user} id={currentTab} />
                )}
            </div>
          </div>
          <div className="tab-content">
            {userAnswers && (
              <div
                role="tabpanel"
                className={
                  currentTab === "summary" ? "tab-pane active" : "tab-pane"
                }
                id="summary"
              >
                        ...
                        <div className="chooseLocation" id="chooseLocationTab">
                          ...
                          <div className="col-md-12">
                            ...
                            <p className="description text-center">
                              Wählen Sie die Filiale aus, welche Sie besuchen
                              wollen, um weitere Informationen zu erhalten.
                            </p>
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          <div className="row buttons">
                            ...
                            <span className="link" onClick={this.addToBasket}>
                              <img
                                loading="lazy"
                          ...
                          <div className="row text-right buttons">
                            ...
                            <button
                              className="btn"
                              onClick={() =>
                                this.changeSummaryTabContent("chooseLocation")
                              }
                            >
                              Ladenlokal besuchen
                              <img
            ...
            {userAnswers && (
              <div
                role="tabpanel"
                className={
                  currentTab === "form" ? "tab-pane active" : "tab-pane"
                }
                id="form"
              >
                <div className="clearfix">
            ...
            >
              <div className="clearfix periods">
                <div className="col-sm-4 itemPeriod">
                  <div className="image">
                    <div className="num">
                      <img loading="lazy" src="/images/design/1.svg" alt="ds" />
                    </div>
                    <img
                      loading="lazy"
                      src="/images/design/estimate-icon-new.svg"
                      alt=""
                    />
                  </div>
                  <h4>Gerät zurücksetzen</h4>
                  <p>
                    Löschen Sie alle Daten auf Ihrem Gerät indem Sie es auf die
                ...
                <div className="col-sm-4 itemPeriod">
                  <div className="image">
                    ...
                    <img
                      loading="lazy"
                      src="/images/design/send-icon-new.svg"
                      alt=""
                    />
                  </div>
                ...
                <div className="col-sm-4 itemPeriod">
                  <div className="image">
                    ...
                    <img
                      loading="lazy"
                      src="/images/design/get-icon-new.svg"
                      alt=""
                    />
                  </div>
              ...
              <div className="row">
                <p className="comment">
                  Wir haben Ihnen ebenfalls das Versandlabel und die Anleitung
                  via E-Mail zugesende
                </p>
                <a
